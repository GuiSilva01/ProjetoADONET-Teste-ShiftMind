...
namespace SmartAdminMvc
{
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string controller, string attribute, string action = "")
        {
        ...
        public static System.Globalization.DateTimeFormatInfo DTFT(string localization= "pt-BR")
        {
            return new System.Globalization.CultureInfo(localization).DateTimeFormat;
