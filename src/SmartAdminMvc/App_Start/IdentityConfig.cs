...
namespace SmartAdminMvc
{
    ...
    public class ApplicationUserManager : UserManager<Usuario>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Usuario>(context.Get<FoPagAuxDbContext>()));
            ...
            manager.MaxFailedAccessAttemptsBeforeLockout = 99;
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<FoPagAuxDbContext>()));
        }
    }
